...
# start_band_list = [2686]
# stop_band_list = [2900]

start_band_list = [30, 57, 88, 108, 130, 174, 216, 265, 406, 470, 512, 608, 698, 806, 902, 928, 960, 1200, 1300, 1400, 1525, 1710, 1850, 1990, 2110, 2200, 2300, 2360, 2390, 2500, 2686]

stop_band_list = [57, 88, 108, 129.99, 174, 216, 265, 406, 470, 512, 608, 697.99, 806, 902, 928, 960, 1199.99, 1300, 1400, 1525, 1710, 1850, 1990, 2110, 2200, 2300, 2360, 2390, 2500, 2686, 2900]

assert len(start_band_list) == len(stop_band_list), "ERROR: Number of start and stop band list frequencies don't match!"

for i in range(0, len(start_band_list)):
	# Start and stop "date time"
	start_period = "09-20-2014 00:00:00"
	stop_period = "09-20-2014 23:59:59"
